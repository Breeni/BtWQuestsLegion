-- BtWQuests_AddChain(BTWQUESTS_CHAIN_LEGION_HIDDEN_KOSUMOTH, {
...
BtWQuests_AddChain(BTWQUESTS_CHAIN_LEGION_HIDDEN_MINDWORM, {
...
-- BtWQuests_AddChain(BTWQUESTS_CHAIN_LEGION_HIDDEN_SUNDARTER, {
...
BtWQuests_AddChain(BTWQUESTS_CHAIN_LEGION_HIDDEN_LUCIDNIGHTMARE, {
...
BtWQuests_AddChain(BTWQUESTS_CHAIN_LEGION_HIDDEN_UUNA, {
    name = "Uuna",
    category = BTWQUESTS_CATEGORY_LEGION_HIDDEN,
    expansion = BTWQUESTS_EXPANSION_LEGION,
    completed = {
...
BtWQuests_AddCategory(BTWQUESTS_CATEGORY_LEGION_HIDDEN, {
