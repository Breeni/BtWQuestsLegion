BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_THEGNOLLOFFENSIVE] = {
	name = GetAchievementCriteriaInfo(4902, 1),
	category = BTWQUESTS_CATEGORY_CLASSIC_REDRIDGEMOUNTAINS,
	...
	items = {
		...
		{
			type = "chain",
            id = BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_KEESHANSRAIDERS,
            aside = true,
			x = 3,
			y = 6,
        },
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_KEESHANSRAIDERS] = {
	...
	items = {
		...
		{
			type = "chain",
			id = BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_FIRSTBLOOD,
			x = 3,
			y = 10,
        },
	}
}
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_FIRSTBLOOD] = {
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_CHAIN1] = {
	name = "Tower Watch",
	category = BTWQUESTS_CATEGORY_CLASSIC_REDRIDGEMOUNTAINS,
	expansion = BTWQUESTS_EXPANSION_CLASSIC,
	range = {15, 60},
...
BtWQuests_Categories[BTWQUESTS_CATEGORY_CLASSIC_REDRIDGEMOUNTAINS] = {
	name = GetMapNameByID(36),
	expansion = BTWQUESTS_EXPANSION_CLASSIC,
	buttonImage = 1498157,
	items = {
		{
			type = "chain",
			id = BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_CHAIN1,
		},
		{
			type = "chain",
			id = BTWQUESTS_CHAIN_CLASSIC_REDRIDGEMOUNTAINS_THEGNOLLOFFENSIVE,
...
table.insert(BtWQuests_Expansions[BTWQUESTS_EXPANSION_CLASSIC], {
    type = "category",
    id = BTWQUESTS_CATEGORY_CLASSIC_REDRIDGEMOUNTAINS,
})