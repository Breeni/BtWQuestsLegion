...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_FORSAKEN_HIGH_COMMAND] = {
	...
	items = {
		{
			variations = {
				...
				},
				{
					...
					breadcrumb = true,
					onClick = function ()
						BtWQuests_ShowMapWithWaypoint(21, 0, 0.5741, 0.1013, "Grand Executor Mortuus")
					end,
				}
			},
			x = 3,
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_FORSAKEN_REAR_GUARD] = {
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_THE_SEPULCHER] = {
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_THE_RUINS_OF_GILNEAS] = {
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_AMBERMILL] = {
...
BtWQuests_Chains[BTWQUESTS_CHAIN_CLASSIC_SILVERPINE_FOREST_ON_THE_BATTLEFRONT] = {
